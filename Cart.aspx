        ...
        <form runat="server">
		   ...
		   <nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br/>
            ...
            <div class="w3-main" style="margin-left:300px">
                ...
                <!--id=cart-->
                <div runat="server" id="cart"></div>

                <div class="w3-row w3-section"style="width: 500px;margin-top:900px ;margin-left: 250px; padding: 5px">
    <asp:Button runat="server" onclick="redirect_buy_now" ID="buy_now"  class="w3-button w3-block w3-section w3-teal w3-ripple w3-padding" Text="Buy Now" > </asp:Button>
    </div>
